...
namespace VkNet.Categories
{
    ...
    public class DatabaseCategory
    {
        ...
        [Pure]
        [ApiVersion("5.44")]
        public ReadOnlyCollection<City> GetCities(long countryId, int? regionId = null, string query = "", bool? needAll = false, int? count = null, int? offset = null)
        {
            VkErrors.ThrowIfNumberIsNegative(() => countryId);
        ...
        [Pure]
        [ApiVersion("5.44")]
        public ReadOnlyCollection<University> GetUniversities(int countryId, long? cityId, string query = "", int? count = null, int? offset = null)
        {
            VkErrors.ThrowIfNumberIsNegative(() => countryId);
